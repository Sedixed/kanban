 ...
 */
final class Version20221103165119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kanban CHANGE privacy privacy INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE kanban CHANGE privacy privacy TINYINT(1) NOT NULL');
    }
}
